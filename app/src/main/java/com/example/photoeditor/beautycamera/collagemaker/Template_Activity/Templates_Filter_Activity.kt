...
import com.example.photoeditor.beautycamera.collagemaker.databinding.ActivityTemplatesFilterBinding

class Templates_Filter_Activity : AppCompatActivity() {

    lateinit var binding : ActivityTemplatesFilterBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTemplatesFilterBinding.inflate(layoutInflater)
