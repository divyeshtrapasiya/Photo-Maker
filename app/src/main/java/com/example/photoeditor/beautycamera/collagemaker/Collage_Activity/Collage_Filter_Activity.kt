...
import com.example.photoeditor.beautycamera.collagemaker.databinding.ActivityCollageFilterBinding

class Collage_Filter_Activity : AppCompatActivity() {

    lateinit var binding : ActivityCollageFilterBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCollageFilterBinding.inflate(layoutInflater)
