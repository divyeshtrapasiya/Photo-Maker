...
import com.example.photoeditor.beautycamera.collagemaker.Adaptor.EditAddImageAdapter
import com.example.photoeditor.beautycamera.collagemaker.databinding.ActivityEditImageAddBinding
import java.io.File
...
class Edit_Image_Add_Activity : AppCompatActivity() {

    lateinit var binding: ActivityEditImageAddBinding
    private lateinit var imageUris: ArrayList<Uri>
    private lateinit var adapter: EditAddImageAdapter
    ...
    companion object {
        ...
        private const val TAG = "EditGalleryImageActivity"
        private const val EXTRA_IMAGE_URI =
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEditImageAddBinding.inflate(layoutInflater)
        setContentView(binding.root)


        imageUris = ArrayList()
        adapter = EditAddImageAdapter(this, imageUris, { uri ->
            openEditImageActivity(uri)
        },{
            openCamera()
        })

        binding.galleryRecycleview.layoutManager = GridLayoutManager(this, 4)
        binding.galleryRecycleview.adapter = adapter
