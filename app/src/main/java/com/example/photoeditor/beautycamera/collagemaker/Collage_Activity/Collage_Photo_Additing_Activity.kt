...
class Collage_Photo_Additing_Activity : AppCompatActivity() {

    lateinit var binding: ActivityCollagePhotoAdditingBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCollagePhotoAdditingBinding.inflate(layoutInflater)
    ...
    private fun showoption() {
        ...
        binding.imageright.setOnClickListener {
            ...
            val intent = Intent(this,Collage_Edit_Image_Activity::class.java)
