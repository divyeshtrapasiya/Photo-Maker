...
import com.example.photoeditor.beautycamera.collagemaker.Adaptor.FreestyleAddImageAdapter
...
import com.example.photoeditor.beautycamera.collagemaker.databinding.ActivityFreestyleAddImageBinding
import java.io.File
...
class Freestyle_Add_Image_Activity : AppCompatActivity() {

    lateinit var binding : ActivityFreestyleAddImageBinding
    private lateinit var imageUris: ArrayList<Uri>
    private lateinit var adapter: FreestyleAddImageAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFreestyleAddImageBinding.inflate(layoutInflater)
        setContentView(binding.root)

        imageUris = ArrayList()
        adapter = FreestyleAddImageAdapter(this, imageUris, { uri ->
